...
> 观众的小问题： 说说[codis](https://github.com/CodisLabs/codis)这个大规模分布式缓存项目
...
> 观众的小问题： 模块多是否会带来`communication overhead`？
...
> 观众的小问题： `PD`的存储是否类似于[etcd](https://github.com/etcd-io/etcd)？
