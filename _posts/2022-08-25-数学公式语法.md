...
```
$\begin{array}{lll}˙  \ensuremath{\operatorname{PV}}_0 & = &˙  \frac{\ensuremath{\operatorname{CF}}}{1 + r} +˙  \frac{\ensuremath{\operatorname{CF}}}{(1 + r)^2} +˙  \frac{\ensuremath{\operatorname{CF}}}{(1 + r)^3} + \cdots +˙  \frac{\ensuremath{\operatorname{CF}}}{(1 + r)^n}\\˙  & = & \frac{\frac{\ensuremath{\operatorname{CF}}}{1 + r} \left[ 1 - \left(˙  \frac{1}{1 + r} \right)^n \right]}{1 - \frac{1}{1 + r}}\\˙  & = & \frac{\ensuremath{\operatorname{CF}} \left[ 1 - \left( \frac{1}{1 +˙  r} \right)^n \right]}{1 + r - 1}\\˙  & = & \ensuremath{\operatorname{CF}} \frac{1}{r} \left[ 1 - \frac{1}{(1 +˙  r)^n}  \right]˙\end{array}$
```

- 删除头部`array`，转换成`aligned`
- 删除`˙`
- 删除`\operatorname`
- 删除`\ensuremath`
- `& = &`修改成`& =`
